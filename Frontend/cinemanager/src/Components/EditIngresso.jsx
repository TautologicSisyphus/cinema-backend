...
const EditIngressoModal = ({ ingresso, onUpdate, onClose }) => {
  const [form, setForm] = useState(ingresso);
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <form onSubmit={handleSubmit} className="bg-[#270707] p-6 rounded shadow-lg w-96">
        <h2 className="text-xl text-[#C0C0C0] font-bold mb-4">Editar ingresso</h2>
...
export default EditIngressoModal;
