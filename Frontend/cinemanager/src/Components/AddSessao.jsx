  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <form onSubmit={handleSubmit} className="bg-[#270707] p-6 rounded shadow-lg w-96">
        ...
        <input type="time" className="w-full border p-2 mb-2 bg-gray-200 rounded-lg" placeholder="Horario" value={form.horario} onChange={e => setForm({ ...form, horario: e.target.value })} required />
